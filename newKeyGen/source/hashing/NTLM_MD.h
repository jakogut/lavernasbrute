...
#define round2_md(set, wd_index, a, b, c, ntb_index, rotation) \
	wd[set][wd_index] = _mm_add_epi32(wd[set][wd_index], _mm_add_epi32(_mm_add_epi32(_mm_or_si128(_mm_and_si128(wd[set][a], _mm_or_si128(wd[set][b], wd[set][c])), _mm_and_si128(wd[set][b], wd[set][c])), nt_buffer[set][ntb_index]), SQRT_2_md)), \
	wd[set][wd_index] = ROTL_md(wd[set][wd_index], rotation)

#define round3_md(set, wd_index, a, b, c, ntb_index, rotation) \
	wd[set][wd_index] = _mm_add_epi32(_mm_add_epi32(_mm_add_epi32(wd[set][wd_index], _mm_xor_si128(wd[set][a], _mm_xor_si128(wd[set][b], wd[set][c]))), nt_buffer[set][ntb_index]), SQRT_3_md), \
	wd[set][wd_index] = ROTL_md(wd[set][wd_index], rotation)
